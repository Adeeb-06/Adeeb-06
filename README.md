...
I’m a full-stack web developer who loves turning ideas into smooth, high-performance digital experiences.  
I work mostly with **Next.js & MERN**, focusing on clean architecture, fast APIs, and modern UI/UX.  

I enjoy building products that solve real problems — from small business websites to full-scale applications.  
Right now, I'm sharpening my skills in **machine learning, data analysis, and blockchain** to expand the type of products I can build.

I’m always exploring new technologies, improving my craft, and looking for opportunities where code meets creativity.
...
|-------------|------------------|
| **Frontend** | [![My Skills](https://skillicons.dev/icons?i=js,html,css,nextjs,tailwind,)](https://skillicons.dev) |
